...
<body>
    <div class="mainframe">
        ...
        <div class="sidebar">
            ...
            <div class="leftbox">
                <ul class="sidemenu">
                    ...
                    <li><a href="admin_update.php" style="color: crimson;">Update event</a></li>
        ...
        <div class="main">
            ...
            <div class="adder"> 
                <form action="">
                    <label for="chooseEvent">Choose event : </label><input type="number" name="chooser" id="">
                    <label for="year">Year: </label><input type="text" id="year" name="year" ><br><br>
                    <label for="month">Month: </label><input type="text" id="year" name="year"><br><br>
                    <label for="date">Day: </label><input type="text" id="year" name="year"><br><br>
                    <label for="extended">Extended: </label><input type="checkbox" name="extended" id="extended"><br><br>
                    <label for="countryID"><a href="countries.html" target="_blank">Country ID</a> </label><input type="text" name="countryID" id="countryID"><br><br>
                    <label for="country">Country: </label><input type="text" name="country" id="country"><br><br>
                    ...
                    <label for="targsubtype"><a href="#">Targ subtypes</a></label><input type="text" name="targsubtype" id="targsubtype" ><br><br>
                    ...
                    <label for="nationality"><a href="#">Nationality:</a></label><input type="text" name="nationality" id="nationality" ><br><br>
